...
drop policy if exists premium_read on public.client_premium; create policy premium_read on public.client_premium for select to authenticated using(true);
...
drop policy if exists premium_docs_read on public.client_premium_documents; create policy premium_docs_read on public.client_premium_documents for select to authenticated using(true);
...
drop policy if exists premium_plan_read on public.client_premium_planning_items; create policy premium_plan_read on public.client_premium_planning_items for select to authenticated using(true);
