...
import {
  ...
  HeartPulse, FileBarChart, Settings2, Clock, BarChart3, Link2, Receipt,
} from "lucide-react";
      ...
      <div className="inline-flex rounded-lg border border-border bg-card p-1">
        <button
          ...
          className={`inline-flex items-center gap-1.5 rounded-md px-3 py-1.5 text-xs font-medium transition-colors ${
            mode === "reel" ? "bg-primary text-primary-foreground" : "text-muted-foreground hover:text-foreground"
          }`}
        >
        ...
        <button
          ...
          className={`inline-flex items-center gap-1.5 rounded-md px-3 py-1.5 text-xs font-medium transition-colors ${
            mode === "projection" ? "bg-primary text-primary-foreground" : "text-muted-foreground hover:text-foreground"
          }`}
        >
