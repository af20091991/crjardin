...
function EditFiche() {
  ...
  const save = useMutation({
    mutationFn: (input: WorksiteSheetInput) =>
      updateWorksiteSheet(ficheId, input),
    onSuccess: () => {
  ...
  async function duplicate() {
    ...
    try {
      ...
      toast.error(
        e instanceof Error ? e.message : "Échec de la duplication",
      );
    }
  }
  ...
  async function exportPdf() {
    ...
    try {
      ...
      toast.error(
        e instanceof Error ? e.message : "Échec de l'export",
      );
    } finally {
      setExporting(false);
    }
