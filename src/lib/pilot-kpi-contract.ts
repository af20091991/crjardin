...
const CONTRACTS: KpiContract[] = [
  ...
  },
  {
    ...
    scope: "Mode transmis explicitement à projectYear : « reel » = réalisé à date sans extrapolation ; « projection » = réalisé à date + extrapolation des mois restants. Base réelle identique dans les deux modes (date ≤ date de référence).",
    filters: [REAL_FILTER],
    excludes: [
