            ...
            <div className="space-y-1.5">
              ...
              <div className="flex flex-wrap gap-2 pt-1">
                {INTERVENANTS.map((n) => (
                  <Chip
                    key={n}
                    active={form.intervenants.includes(n)}
                    onClick={() =>
                      set(
                        "intervenants",
                        form.intervenants.includes(n)
                          ? form.intervenants.filter((x) => x !== n)
                          : [...form.intervenants, n],
                      )
                    }
                  >
              ...
              <p className="text-xs text-muted-foreground">
                {form.intervenants.length} SST sélectionné{form.intervenants.length > 1 ? "s" : ""}
              </p>
            </div>
          </div>
          <div className="grid gap-4 sm:grid-cols-2">
