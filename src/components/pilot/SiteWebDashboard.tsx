      ...
      <header className="flex items-start gap-3">
        ...
        <div>
          ...
          <p className="mt-1 max-w-2xl text-sm text-muted-foreground">
            Qui vient sur le site, comment on nous trouve, où nous progressons
            et quoi travailler ensuite.
          </p>
        </div>
      </header>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  Le trafic réel du site (Analytics 4) et la façon dont Google
                  l'amène jusque-là (Search Console), sur la même période.
                </p>
              </div>
            </div>
          </Card>
          ...
          <Card className="p-5">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  Les points à fort potentiel identifiés à partir des données
                  disponibles.
                </p>
              </div>
            </div>
      ...
      {activeView === "actions" && (
        <div className="space-y-5">
          <Card className="p-5">
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Le suivi opérationnel reste séparé des mesures et des
              recommandations.
            </p>
          </Card>
          <SiteWebActionsView />
